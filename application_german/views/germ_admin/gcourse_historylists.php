...
$( document ).ready(function() {
    $('#listening_grid').DataTable({
        ...
        initComplete: function(){
           $("div.toolbar").html('<button onclick="addGhistory()" type="button" class="btn btn-outline btn-primary btn-xs">Add German History</button>');           
        },
        ...
        "serverSide": true,
        "ajax":{
            url :"germ_admin/gcourse_test/ajax_gcoursehistorylists", // json datasource
...
function addGhistory(){
    window.location.href = "germ_admin/gcourse_test/add_gcourse_history";
}
</script>