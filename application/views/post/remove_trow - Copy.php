...
<!--    <tr id="theadrow">-->
    <tr id="theadrow">
        <th onclick="removeTableMultipleRow(<?php echo $post_id;?>)">#</th>
        <?php 
        ...
        ?>
            <?php //if(!empty($lists_data[0][$p])){?> <th id="sheet<?php echo $alpha_arr[$p].'1';?>"><span onclick="deleteTableCol('<?php echo $alpha_arr[$p];?>','<?php echo $post_id;?>')"><i class="fa fa-trash table_del" data-original-title="Delete" style="cursor:pointer"></i></span>&nbsp;&nbsp;<span onclick="updateSheetCol('<?php echo $alpha_arr[$p].'1';?>','<?php echo $lists_data[0][$p];?>')"><i class="fa fa-pencil table_edit" data-original-title="Delete" style="cursor:pointer"></i></span><?php echo $lists_data[0][$p];?></th><?php  //}?>
        <?php
            }
        }
        ?>
...
<tbody id="tbodyrow">
    ...
    ?>
        <tr>
            <td onclick="removeTableRow('<?php echo $post_id;?>','<?php echo $m+1;?>')"><i class="fa fa-trash" data-original-title="Delete" style="cursor:pointer"></i></td>
    <?php
