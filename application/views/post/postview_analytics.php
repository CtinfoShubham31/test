...
<script type="text/javascript" src="js/viewers_graph.js"></script> 
            ...
            <div class="col-md-12">
                ...
                <div class="tab">
                    <nav class="tab-nav mini-tab no-collapse">
                        <ul class="dragscroll">
                            <li class="active"><a href="post/analytics/postview_analytics/<?php echo base64_encode($post_id);?>">Views</a></li>  
