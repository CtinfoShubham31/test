...
<script type="text/javascript" src="js/followers_graph.js"></script> 
                ...
                <div class="tab">
                    <nav class="tab-nav mini-tab no-collapse">
                        <ul class="dragscroll">
                            ...
                            <li class="active"><a href="post/analytics/postfollow_analytics/<?php echo base64_encode($post_id);?>">Followers</a></li>  
                            <li><a href="post/analytics/posthelpful_analytics/<?php echo base64_encode($post_id);?>">Helpful</a></li>  
                        </ul>
                    </nav>
