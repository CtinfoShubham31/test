                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="clearfix"></div>
                                 ...
                                 <div id="tmodule" style="display:none">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label for="">Time Module</label>
                                            <input type="text" name="time_module" id="time_module" class="form-control" placeholder="Time Module">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <input type="submit" class="btn btn-success top-20" name="module" value="Add Time Module">
                                    </div>
                                </div>   
                                <div class="clearfix"></div>
                ...
                if(optionValue == 5){
                    ...
                    var schedulerDataSource = new DevExpress.data.DataSource({
                        ...
                        remove: function(key) {        
                            //console.log(key);
                            return $.ajax({
                                url: "post/manage_post/delete_timeplanner/<?php echo $pstid= base64_decode($this->uri->segment(4));?>",
                                method: "POST",
                                data:key,
                                success: function( result) {               
                                    console.log(result); 
                        ...
                        update: function(key, values) { 
                            return $.ajax({
                                url: "post/manage_post/update_timeplanner/<?php echo $pstid= base64_decode($this->uri->segment(4));?>",
                                method: "POST",
                                data: values,
                                success: function( result) {             
                                    console.log(result); 
                    ...
                    //var obj = JSON.parse(priorityData);
                    //priorityData.push({"id":1,"color":"1e90ff","text":"Low Priority"});
                    //priorityData = JSON.stringify(obj);
                    //alert(priorityData);
