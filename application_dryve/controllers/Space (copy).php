...
//            }
    ...
    public function search_parking_space() {
        ...
        $from_datetime = date("Y-m-d H:i:s", strtotime(trim($this->input->post("fromdatetime"))));
        $to_datetime = date("Y-m-d H:i:s", strtotime(trim($this->input->post("todatetime"))));
