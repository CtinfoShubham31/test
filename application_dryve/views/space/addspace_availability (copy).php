        ...
        <div class="container">
            ...
            <div class="topTabs">
                <ul>
                    ...
                    <li><center><a href="space/addspace_availability" class="active">4</a></center><br><span>Set Availability</span></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group col-md-12">
                            <div>
                                <form>
                                <div class="checkbox">
                                    <label style="font-weight:bold"><input type="checkbox" class="ck-box" value="">&nbsp; 24 Hours </label>
                                </div>
                                </form>
                            </div>
                        </div>
