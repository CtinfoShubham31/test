...
<section class="content">
    <div class="row">
        <form>
          ...
          <label> Select date range</label>
            <div class="form-group input-group date">
              <input type="text" id="config-demo" class="form-control sign-control" placeholder="select date range">
          ...
          <label> Select Interval</label>
              <select class="form-control sign-control" id="usage">
                <option> Daily  </option>
        ...
        <div id="axis_hide1" class="chart-fix">    
        </div>
      ...
      var options = {
       /* title: "Expense Product Chart",*/
		...
		hAxis: {
			...
			TextStyle: {color: '#424242', position:'absolute'},								
			},
		vAxis:{
			textStyle:{color: '#FFF'},
			title:'Name',
