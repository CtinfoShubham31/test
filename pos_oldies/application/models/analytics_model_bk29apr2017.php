...
//            return $data;
    ...
    public function getEmployeeSalesReport($company_id,$from,$to){
        $sql = "SELECT employee_name, sum_amount
            FROM(SELECT SUM(final_amount) as sum_amount,employee_id, sales_order_date
...
//            return $data;
    ...
    public function getCategorySalesReport($company_id,$from,$to){
        $sql = "SELECT category_name, sum_amount
        FROM(SELECT SUM(sales_amount) as sum_amount, inventory_category_id, sales_order_date
        FROM pos_sales_order_transaction
        WHERE company_id = $company_id AND (sales_order_date BETWEEN '$from' AND '$to')
...
//            SUM(IF(payment_method_id = 2, paid_amount, 0)) AS mswipe, SUM(IF(payment_method_id = 3, paid_amount, 0)) AS paytm
//        FROM pos_sales_order 
...
//        $query = $this->db->query($sql);
        ...
        $sql = "SELECT DATE_FORMAT(sales_order_date,'%m-%d-%Y'), SUM(sum_cash) AS Cash, SUM(sum_mswipe) AS Mswipe, SUM(sum_paytm) AS Paytm	
        ...
        SUM(IF(payment_method_id = 3 AND payment_split = 0, paid_amount, 0)) AS sum_paytm
        FROM pos_sales_order 
        WHERE company_id = $company_id AND (sales_order_date BETWEEN '$from' AND '$to')
        GROUP BY sales_order_date 
        UNION
        ...
        SUM(IF(payment_method_id = 3, split_amount, 0)) AS sum_split_paytm
...
//            return $data;
    ...
    public function paymentReceivedWeekwise($company_id,$from='',$to=''){
        ...
        SUM(sum_cash) AS Cash, SUM(sum_mswipe) AS Mswipe, SUM(sum_paytm) AS Paytm	
        FROM (SELECT sales_order_date, SUM(IF(payment_method_id = 1 AND payment_split = 0, paid_amount, 0)) AS sum_cash, SUM(IF(payment_method_id = 2 AND payment_split = 0, paid_amount, 0)) AS sum_mswipe,
        SUM(IF(payment_method_id = 3 AND payment_split = 0, paid_amount, 0)) AS sum_paytm
        FROM pos_sales_order 
        WHERE company_id = $company_id AND (sales_order_date BETWEEN '$from' AND '$to')
...
//            return $data;
    ...
    public function paymentReceivedMonthwise($company_id,$from='',$to=''){
        $sql = "SELECT monthname(sales_order_date), SUM(sum_cash) AS Cash, SUM(sum_mswipe) AS Mswipe, SUM(sum_paytm) AS Paytm	
        FROM (SELECT sales_order_date, SUM(IF(payment_method_id = 1 AND payment_split = 0, paid_amount, 0)) AS sum_cash, SUM(IF(payment_method_id = 2 AND payment_split = 0, paid_amount, 0)) AS sum_mswipe,
        SUM(IF(payment_method_id = 3 AND payment_split = 0, paid_amount, 0)) AS sum_paytm
        FROM pos_sales_order 
        WHERE company_id = $company_id AND (sales_order_date BETWEEN '$from' AND '$to')
